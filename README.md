...
The creating process requires a few things:
<ul>
    ...
    This method reduces the quality of the image if the filesize is too large for Youtube. This only happens if the image is jpg.</li>
</ul>
